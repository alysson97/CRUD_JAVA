...
-- Create institucional table (unchanged)
...
-- Create nivelUsuarios table (unchanged)
...
-- Create usuarios table (unchanged)
...
-- Create pedidos table (unchanged)
...
-- Create produtos table with foreign key constraint
...
CREATE TABLE `produtos` (
  ...
  `profundidade` decimal(10,3) DEFAULT NULL,
...
-- Create estoque table (unchanged)
...
-- Create itemsPedido table (unchanged)
